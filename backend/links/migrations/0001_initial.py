# Generated by Django 4.2.2 on 2024-01-31 12:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alias_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='links.aliasshortlink', verbose_name='Пользовательская ссылка группы')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_link', to='links.usergroup', verbose_name='Группа пользователя')),
                ('short_link', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='links.shortlink', verbose_name='Короткая ссылка группы')),
            ],
            options={
                'verbose_name': 'Группа ссылок',
                'verbose_name_plural': 'Группы ссылок',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('group', 'alias_link'), name='unique_alias_link_per_group', violation_error_message='Пользовательская ссылка уже в другой группе'),
        ),
        migrations.AddConstraint(
            model_name='usergrouplink',
            constraint=models.UniqueConstraint(fields=('group', 'short_link'), name='unique_short_link_per_group', violation_error_message='Короткая ссылка уже в другой группе'),
        ),
        migrations.AddConstraint(
