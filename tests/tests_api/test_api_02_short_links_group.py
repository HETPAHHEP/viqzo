...
class Test02ShortLinksWithGroup:
    ...
    def test_01_01_create_and_add_short_link_to_group(self, user_client, name_for_usergroup, valid_original_link):
        group_id = utils.create_usergroup(user_client, name_for_usergroup)
        utils.add_created_group_to_dict_with_link(valid_original_link, group_id)

        response = user_client.post(f'/api/links/', data=valid_original_link)
    ...
    def test_01_02_create_and_add_alias_link_to_group(self, user_client, name_for_usergroup, original_link_with_alias):
        group_id = utils.create_usergroup(user_client, name_for_usergroup)
        utils.add_created_group_to_dict_with_link(original_link_with_alias, group_id)

        response = user_client.post(f'/api/links/', data=original_link_with_alias)
        assert (response.status_code == HTTPStatus.CREATED
                and response.data['group']['id'] == group_id), (
            f'POST-запрос от авторизованного пользователя '
    ...
    def test_01_04_create_and_add_links_to_group_twice(
            ...
            valid_original_link, original_link_with_alias, original_link_with_other_alias
    ):
        group_id = utils.create_usergroup(user_client, name_for_usergroup)
        utils.add_created_group_to_dict_with_link(valid_original_link, group_id)
        ...
        utils.add_created_group_to_dict_with_link(original_link_with_other_alias, group_id)

        response = user_client.post(f'/api/links/', data=original_link_with_other_alias)
    ...
    def test_02_01_edit_group_at_short_link(
            self, user_client, valid_original_link, name_for_usergroup, new_name_for_usergroup
    ):
        link_short_code, group_id = utils.create_and_add_short_link_to_group(
            user_client, valid_original_link, name_for_usergroup
        )

        new_group_id = utils.create_usergroup(user_client, new_name_for_usergroup)

        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict(new_group_id)
        )
    ...
    def test_02_02_edit_group_at_alias_link(
            self, user_client, original_link_with_alias, name_for_usergroup, new_name_for_usergroup
    ):
        link_short_code, group_id = utils.create_and_add_short_link_to_group(
    ...
    def test_02_03_edit_non_existent_group_at_link(
            self, user_client, valid_original_link, original_link_with_alias, name_for_usergroup, new_name_for_usergroup
    ):
        link_short_code, group_id = utils.create_and_add_short_link_to_group(
            user_client, valid_original_link, name_for_usergroup
        )
        ...
        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict(666)
        )
    ...
    def test_02_04_edit_group_at_link_with_same_id(
            self, user_client, original_link_with_alias, name_for_usergroup, valid_original_link, new_name_for_usergroup
    ):
        link_short_code, group_id = utils.create_and_add_short_link_to_group(
            user_client, original_link_with_alias, name_for_usergroup
        )
        ...
        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict(group_id)
        )
    ...
    def test_02_05_edit_not_own_group_at_link(
            self, user_client, user_client2, valid_original_link,
            original_link_with_alias, name_for_usergroup, new_name_for_usergroup
    ):
        ...
        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict(other_group_id)
        )
    ...
    def test_02_06_edit__link_with_char_group_field(
            self, user_client, valid_original_link,
            original_link_with_alias, name_for_usergroup, new_name_for_usergroup
    ):
        link_short_code, group_id = utils.create_and_add_short_link_to_group(
            user_client, valid_original_link, name_for_usergroup
        ...
        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict('First')
        )
        ...
        response = user_client.patch(
            f'/api/links/{link_short_code}/', data=utils.add_created_group_to_dict('Second')
        )
    ...
    def test_03_01_filter_links_by_group(
            ...
            valid_original_link, original_link_with_alias
    ):
        link_short_code_1, group_id_1 = utils.create_and_add_short_link_to_group(
            user_client, valid_original_link, name_for_usergroup
        )

        link_short_code_2, group_id_2 = utils.create_and_add_short_link_to_group(
            user_client, original_link_with_alias, new_name_for_usergroup
        )
    ...
    def test_03_03_filter_not_own_links_by_group(
            self, user_client, name_for_usergroup, new_name_for_usergroup,
            valid_original_link, original_link_with_alias, user_client2
    ):
        link_short_code_1, group_id_1 = utils.create_and_add_short_link_to_group(
            user_client, valid_original_link, name_for_usergroup
        )
